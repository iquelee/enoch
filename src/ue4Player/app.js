...
function connect() {
    ...
    // ws = new WebSocket('ws://192.168.1.113/');
...
export function appLoad(signalServerAddr, onFinish) {
...
// 前端发消息给后端，并监听返回
export function apiSend(proto, data, callback) {
...
// 监听从后端直接发送过来的消息
export function apiRegister(proto, callback) {
    responseEventListeners.set(proto, callback);
}
